...
3. Use os 5 DSs-base da personalidade escolhida como insumo.
4. Nao gere novamente esses 5 DSs dentro da pasta do cliente.
5. Cruze o DS inicial do cliente com os 5 DSs-base existentes.
...
Se elas reaparecerem, remova. O cliente final deve nascer somente do DS inicial do cliente, dos 5 DSs-base em `design-systems/json/`, dos previews leves, do DS final e dos assets permitidos.
